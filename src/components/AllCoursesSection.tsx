              ...
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center px-3 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 text-sm whitespace-nowrap min-w-0"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center px-3 py-2.5 bg-white border border-blue-200 text-blue-700 hover:bg-blue-50 font-medium rounded-lg transition-all duration-300 shadow-sm text-sm whitespace-nowrap min-w-0"
                  >
